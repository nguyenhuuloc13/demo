          ...
          <div className="m-4 md:mx-12 md:my-6 grid grid-cols-4 lg:grid-cols-3">
            ...
            <div className="col-span-2 lg:hidden flex justify-items-stretch	 items-center">
              ...
              <span
                ...
                className="flex items-left text-center font-bold uppercase text-blue-600 text-2xl cursor-pointer px-2 text-center"
              >
                High Level
              </span>
            </div>
            <div
              ...
              className="hidden lg:block flex items-left col-span-1 text-center text-blue-600 font-bold uppercase text-2xl cursor-pointer"
            >
              High Level
            </div>
